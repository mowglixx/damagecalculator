...
export const Nav = () => {
  ...
  const navLinks = [
    ...
    { name: 'Expenses', href: '/account/expenses' },
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-blue-500 dark:bg-gray-800 p-6 dark:border-b">
      ...
      <div className="w-full block flex-grow md:flex md:items-center md:w-auto" id="navLinksSelector">
        <div className="text-sm md:flex-grow sm:text-center xs:text-center">
        ...
        <div className="text-center">
          <div className="inline-block">
            <Link href="/login">
              <a className="text-sm mx-2 p-2 border rounded text-white border-white hover:border-transparent hover:text-blue-500 hover:bg-white">Login</a>
            </Link>
          </div>
          <div className="inline-block">
            <Link href="/login/create">
              <a className="text-sm mx-2 p-2 border rounded text-white border-white hover:border-transparent hover:text-blue-500 hover:bg-white">Register</a>
            </Link>
          </div>
        </div>
      </div>
